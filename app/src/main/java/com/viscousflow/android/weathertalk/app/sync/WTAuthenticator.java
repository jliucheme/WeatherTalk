...
/**
 * Manages "Authentication" to WeatherTalk's backend service.  The SyncAdapter framework
 ...
 */
public class WTAuthenticator extends AbstractAccountAuthenticator {

    public WTAuthenticator(Context context) {
        super(context);
    }
